...
class ParSort {
    ...
    public static int noOfTheads=1;
    static ForkJoinPool m = new ForkJoinPool(noOfTheads);

   /* public void setNoOfTheads(int noOfTheads) {
        this.noOfTheads = noOfTheads;
    }

    public int getNoOfTheads() {
        return noOfTheads;
    }*/
